...
<?php
    ...
    include("connect.php");
     ...
     if($_SERVER["REQUEST_METHOD"] == "POST")
     {
	  ...
	  {
	  	$s1 = "SELECT Sno FROM registration ORDER BY Sno DESC LIMIT 1";
	  	$s1 = $s1 + 1;
	  	$sql = "INSERT INTO `registration` (`Sno`, `Name`, `Aadhar_no`, `Mail_id`, `Amount_present`, `Vehicle_number`) VALUES ('12', '$name', '$adhr', '$email', '$amt', '$vehi')";
